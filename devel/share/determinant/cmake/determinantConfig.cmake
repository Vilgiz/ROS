...
if(NOT "/home/vilgiz/homework_ws/devel/include " STREQUAL " ")
  set(determinant_INCLUDE_DIRS "")
  set(_include_dirs "/home/vilgiz/homework_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'determinant' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vilgiz/homework_ws/src/determinant/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vilgiz/homework_ws/devel/lib;/home/vilgiz/homework_ws/devel/lib;/opt/ros/noetic/lib)
